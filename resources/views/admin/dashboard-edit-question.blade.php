...
<body>
    <div class="min-h-screen  bg-[#EEF4F6]">
        ...
        <section class="ml-[218px] ">
            <form action="{{ route('admin.dashboard.update-question', $question) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
                    ...
                    <div class="bg-[#4c4a67] h-[250px]  rounded-[8px] flex justify-between p-4">
                        ...
                        @if ($question->image_path != null)
                            <div id="preview" class="w-1/4  py-4 ml-[16px] rounded-xl items-center bg-[#28273a] mt-8">
                                <img id="imagePreview" src="{{ asset('storage/questions/' . $question->image_path) }}" class=" mx-auto text-center" alt="Image Preview" style="max-width: 100%; max-height: 160px;">
