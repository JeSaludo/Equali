        ...
        <div class="min-h-screen  bg-[#F7F7F7]">
            ...
            <section class="sm:ml-64 main">
                ...
                <div class="flex  mx-4 mt-2 justify-between">
                    ...
                    <h1 class="text-[#26386A] text-[18px]  font-bold font-raleway ">List of Exam</h1> <button
                        id="addExamBtn"
                ...
                <div id="examContent">
                    ...
                    @if ($exams->count() == 0)
                        <div
                            class="bg-white mx-4 py-6  flex relative my-2 drop-shadow-sm border border-[#D9DBE3] shadow-md rounded-lg ">
                            <h1 class="text-black mx-auto text-center">No exam found in database</h1>
                        </div>
                    @else
                        @foreach ($exams as $exam)
                            <div
                                class="bg-white mx-4 border border-[#D9DBE3] shadow-md rounded-lg flex relative my-2 drop-shadow-sm ">
                                ...
                                <div class="relative">
                                    ...
                                    <div class="absolute bottom-2 m-2 mr-5 right-0  flex justify-between">
                                        ...
                                        <form action="{{ route('admin.dashboard.delete-exam', $exam->id) }}"
                                    ...
                                    <div class="w-full">
                                        <div class=" my-4">
                                            <input type="text" name="examName"
                                                ...
                                                placeholder="Untitled Exam" autocomplete="off" required>
