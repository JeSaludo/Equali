                    ...
                    <div class="my-6  mx-4   ">
                        <form action="{{ route('admin.dashboard.update-applicant', $user->id) }}" method="POST">
                            ...
                            <div class="bg-white mx-4 rounded-[12px] mt-4  p-4 border-gray-100 border-2">
                                <div
                                    class=" font-poppins text-[22px] flex justify-between font-semibold  text-[#26386A] ">
                                ...
                                <div class="relative mx-8 selection: ">
                                    ...
                                    <select name="measure_b_score" required
                                        ...
                                        <option value="5"
                                            {{ $user->admissionExam->measure_b_score == '5' ? 'selected' : '' }}>
                                            Excellent
                                        </option>
                                        <option value="4"
                                            ...
                                            Average</option>
                                        <option value="3"
                                            {{ $user->admissionExam->measure_b_score == '3' ? 'selected' : '' }}>
                                            Average
                                        </option>
                                        <option value="2"
