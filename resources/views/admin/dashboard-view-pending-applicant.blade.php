    ...
    <div class="min-h-screen  bg-[#F7F7F7]">
        ...
        <section class="ml-[218px] main ">
            ...
            <div class="flex mx-4 my-4" id="navLinks">
                ...
                <a href="#" class="font-poppins  text-slate-500 nav-link ">Pending</a>
                <a href="#" class="font-poppins  text-slate-500 nav-link ">Approved</a>
                <a href="#" class="font-poppins  text-slate-500 nav-link active">Archived</a>
