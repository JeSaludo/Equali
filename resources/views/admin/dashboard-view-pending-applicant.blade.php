    ...
    <div class="min-h-screen  bg-[#F7F7F7]">
        ...
        <section class="ml-[218px] main ">
            ...
            <form action="{{route('admin.dashboard.approve-applicant-multiple')}}" method="POST">
                @csrf
                <div class="mx-4 my-2">
                    <button disabled id="approveBtn"  class="border border-[#D9DBE3] hover:border-slate-400 flex items-center text-[14px] tezt-poppin hover:text-[#384b94] font-poppins text-slate-600 py-1 px-4 rounded-lg">
