            ...
            <section class="sm:ml-64 main">
                ...
                <div class="bg-white mx-4 " id="printSection">
                    ...
                    <div class="flex mx-4 justify-between  gap-2 ">
                        <div class=" px-4 my-1  w-full">
                            <label class="text-sm text-gray-500" for="">Name: </label>
                        ...
                        <div class="px-4 my-1  w-full">
                            <label class="text-sm text-gray-500" for="">Date: </label>
                    ...
                    <div class="flex mx-4 justify-between  gap-2 ">
                        <div class=" px-4 my-1  w-full">
                            <label class="text-sm text-gray-500" for="">Home Address: </label>
                        ...
                        <div class="px-4 my-1 w-full">
                            <label class="text-sm text-gray-500" for="">Course: </label>
                    ...
                    <div class="flex mx-4 justify-between  gap-2 ">
                        <div class=" px-4 my-1  w-full">
                            <label class="text-sm text-gray-500" for="">School Last Attended: </label>
                        ...
                        <div class=" px-4 my-1 w-full">
                            <label class="text-sm text-gray-500" for="">Address: </label>
                    ...
                    <div class="flex mx-4 justify-between  gap-2 ">
                        ...
                        <div class="px-4 my-1 w-full">
                            <label class="text-sm text-gray-500" for="">Year Graduated: </label>
                        ...
                        <div class=" px-4 my-1 w-full">
                            <label class="text-sm text-gray-500" for="">GPA: </label>
                    ...
                    <div class="flex mx-4 justify-between  gap-2 ">
                        ...
                        <div class="px-4 my-2 w-full">
                            <label class="text-sm text-gray-500" for="">Academic Track: </label>
                            ...
                            <select
                                ...
                                <option value="GAS"
                                    {{ $user->studentInfo->academic_track == 'GAS' ? 'selected' : '' }}>
                                    General
                                ...
                                <option value="ST"
                                    {{ $user->studentInfo->academic_track == 'ST' ? 'selected' : '' }}>
                                    Sports Track
                                </option>
                                <option value="ADT"
                            ...
                            <div class="mt-3">
                                ...
                                <div>
                                    <input type="checkbox" name="hasSmartphone" id="" value="1"
                                        disabled {{ $user->studentInfo->has_smartphone ? 'checked' : '' }}>
                    ...
                    <div class="mx-8 font-poppins grid grid-cols-2">
                        ...
                        <div class="grid-col grid text-end text-sm justify-end whitespace-nowrap">
                            ...
                            <h1 type="text" name="interview1" id="interview1" placeholder=""
                                class="score mb-1 border border-[#D7D8D0] text-center block w-[165px]">
                                {{ $user->studentInfo->interviewNo1 }}
                            </h1>
                            <h1 type="text" name="interview2" id="interview2"
                                class="score mb-1 border border-[#D7D8D0] text-center block w-[165px]" value=""
                                required disabled>
