        ...
        <table id="admission-table"
            ...
            <thead class="border-b text-[#26386A] border-[#D9DBE3] font-semibold text-left whitespace-nowrap">
                <tr>
                    ...
                    <td class="px-6 py-2">
                        <a
                            href="{{ route($route, ['sort_column' => 'last_name', 'sort_order' => $sortColumn == 'last_name' && $sortOrder == 'asc' ? 'desc' : 'asc', 'academicYears' => $request->academicYears]) }}">
                    ...
                    @if ($showAdmissionExam)
                        <td class="px-6 py-2">
                            <a
                                href="{{ route($route, ['sort_column' => 'raw_score', 'sort_order' => $sortColumn == 'raw_score' && $sortOrder == 'asc' ? 'desc' : 'asc', 'academicYears' => $request->academicYears]) }}">
                        ...
                        <td class="px-6 py-2">
                            <a
                                href="{{ route($route, ['sort_column' => 'percentage', 'sort_order' => $sortColumn == 'percentage' && $sortOrder == 'asc' ? 'desc' : 'asc', 'academicYears' => $request->academicYears]) }}">
                    ...
                    <td class="px-6 py-2">
                        <a
                            href="{{ route($route, ['sort_column' => 'status', 'sort_order' => $sortColumn == 'status' && $sortOrder == 'asc' ? 'desc' : 'asc', 'academicYears' => $request->academicYears]) }}">
