    ...
    <body>
        ...
        <div class="min-h-screen  bg-[#F7F7F7]">
            ...
            <nav class="ml-[218px] flex justify-between items-center border-b border-[#D9DBE3] h-[60px] bg-white px-4 ">
                @include('admin.partials.search-term', ['route' => 'admin.dashboard.admission.interview']);
            ...
            <section class="ml-[218px] main">
                ...
                @include('admin.partials.admission-table', [
                    'title' => 'List of For Interview Applicants',
                    'showAdmissionExam' => false,
                    'users' => $users,
                    'sortColumn' => $sortColumn,
                    'sortOrder' => $sortOrder,
                    'academicYears' => $academicYears,
                    'route' => 'admin.dashboard.admission.interview',
                ])
