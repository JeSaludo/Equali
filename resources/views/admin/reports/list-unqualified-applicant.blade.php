            ...
            <section class="ml-[218px] main ">
                ...
                <div class="mx-4 my-4">
                    ...
                    <div class="flex justify-between mx-4 my-2">
                        ...
                        <h1 class="text-[#26386A] text-[18px]  font-bold font-raleway">List of Unqualified Applicants
                        </h1>



                        <div>
                            <a href="{{ route('admin.report.unqualified-result') }}"
                        ...
                        <div class="overflow-x-auto">
                            ...
                            <nav
                                ...
                                <a href="{{ $results->previousPageUrl() }}"
                                    class="flex items-center justify-center px-3 h-8 ms-0 leading-tight text-gray-500 bg-white border border-e-0 border-gray-300 rounded-s-lg hover:bg-gray-100 hover:text-[#26386A] {{ $results->currentPage() > 1 ? '' : 'opacity-50 cursor-not-allowed' }}">
                                ...
                                <a href="{{ $results->nextPageUrl() }}"
                                    class="flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 rounded-e-lg hover:bg-gray-100 hover:text-[#26386A] {{ $results->hasMorePages() ? '' : 'opacity-50 cursor-not-allowed' }}">
