                        ...
                        @else
                            @foreach ($questions as $index => $question)
                                <tr class="">
                                    ...
                                    <td class="px-6 py-2 whitespace-nowrap font-poppins  text-[#617388]  text-left">
                                       <div class="flex">
                                            <div class="w-6/12">
                                                {{$DS[$index]}}
                                            </div>
                                    ...
                                    <td class="px-6 py-2 whitespace-nowrap font-poppins  text-[#617388]  text-left">
                                        <div class="flex">
                                             ...
                                             <div class="w-6/12">
                                                 @if($DI[$index] >= 0.86 )
                                                     To be discarded 
                                                 @elseif ($DI[$index] <= 0.85 && $DI[$index] >= 0.71 )
                                                     To  be revised
                                                 @elseif ($DI[$index] <= 0.70 && $DI[$index] >= 0.30 )
                                                     ModeratI
                                                 @elseif ($DI[$index] <= 0.29 && $DI[$index] >= 0.15 )
                                                     DifficulI
                                                 @elseif ($DI[$index] <= 0.14 && $DI[$index] >= 0)
                                                     Very Difficult
                                                 @endif
                                             </div>
                                        </div>
